...
BOT_TOKEN = getenv("BOT_TOKEN", "5708609169:AAGr85PVpvo6Yk06LrRSskbDoDmVCKoxFzU")
BOT_NAME = getenv("BOT_NAME", "NixaX")
BOT_USERNAME = getenv("BOT_USERNAME", "TagallXBot")
ASSID = int(getenv("ASSID", "5470233619"))
ASSNAME = getenv("ASSNAME", "SankiX")
ASSUSERNAME = getenv("ASSUSERNAME", "NixaXAssistant")
BOT_ID = int(getenv("BOT_ID", "5708609169"))
